...
\begin{lstlisting}[style=json,caption={SGXDedup原型系统运行参数},label={lst:sgxdedup-config}]
{
    "ChunkerConfig": {
        "_chunkingType": 1, 
...
\begin{lstlisting}[style=shell,caption={SGXDedup原型系统测试，启动客户端},label{lst:sgxdedup-runtime-client}]
# store file
./client-sgx -s file
