...
本文软件包提供了两个工具包：(1)\sysnameF 模拟器，用于模拟针对推测内容攻击的检测效果；(2)\prototype ，即本文提出的基于TEE的高性能强安全加密重复数据删除原型系统。软件包开源于\url{https://github.com/tinoryj/masterGraduation}中{\em artifacts}目录下。
