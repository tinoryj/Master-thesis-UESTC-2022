...
\begin{lstlisting}[style=json,caption={\sysnameS原型系统运行参数},label={lst:\sysnameS-config}]
{
    "ChunkerConfig": {
        "_chunkingType": 1, 
...
\begin{lstlisting}[style=shell,caption={\sysnameS原型系统测试，启动客户端},label{lst:\sysnameS-runtime-client}]
# store file
./client-sgx -s file
