...
在运行\prototype 之前，请检查设备是否支持Intel SGX。如果BIOS中有SGX或Intel Software Guard Extensions等相关选项，则启用该选项；否则，该设备可能不支持SGX。对于支持的设备型号，强列建议在SGX硬件列表\cite{sgxHardware}中进行查询。
