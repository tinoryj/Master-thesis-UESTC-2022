...
%\begin{tabular}{|c|c|c|c|}
    ...
    \hline
    \hline
    \multirow{8}{*}{\rotatebox{90}{\bf Performance}} & \multirow{4}{*}{\shortstack{Key \\  generation}} & OPRF-BLS \cite{armknecht2015transparent} & 1,583$\times\;\uparrow$  \\
    \cline{3-4}
    ...
    \cline{2-4}
    & \multirow{2}{*}{\shortstack{Overall \\ system}} & {\em DupLESS} \cite{bellare2013DupLESS} & 8.1$\times\;\uparrow$ \\
    \cline{3-4}
