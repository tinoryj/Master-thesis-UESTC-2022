...
% \setdate[oral]{2022年5月30日}  
% \setdate[confer]{2022年} 
% \advisor{}{}
...
% \studentnumber{}
% % \ProfessionalDegreeArea{加密重复数据删除}
...
\setdate[submit]{2022年3月17日}
\setdate[oral]{2022年5月30日}  
\setdate[confer]{2022年6月} 
\advisor{李经纬\chinesespace 副教授}{Prof. Dr. Li Jingwei}
\school{计算机科学与工程学院(网络空间安全学院)}{School of Computer Science and Engineering(School of Cyberspace Security)}
\major{计算机科学与技术}{Computer Science and Technology}
...
\newcommand{\sysnameS}{TEEDedup\xspace}
\newcommand{\sysnameF}{FeatureSpy\xspace}
\newcommand{\prototype}{TEEDedup+\xspace}
...
\newacronym[description=可信执行环境]{tee}{TEE}{\underline{T}rusted \underline{E}xecution \underline{E}nvironment}
\newacronym[description=消息锁加密]{mle}{MLE}{\underline{M}essage-\underline{L}ocked \underline{E}ncryption}
\newacronym[description=无记忆伪随机函数]{oprf}{OPRF}{\underline{O}blivious \underline{P}seudo\underline{R}andom \underline{F}unction}
\newacronym[description=数据所有权证明]{pow}{PoW}{\underline{P}roofs \underline{o}f \underline{O}wnership}
\newacronym[description=收敛加密]{ce}{CE}{\underline{C}onvergent \underline{E}ncryption}
\newacronym[description=哈希收敛加密]{hce}{HCE}{\underline{H}ash \underline{C}onvergent \underline{E}ncryption}
\newacronym[description=随机收敛加密]{rce}{RCE}{\underline{R}andom \underline{C}onvergent \underline{E}ncryption}
\newacronym[description=收敛扩散]{cd}{CD}{\underline{C}onvergent \underline{D}ispersa}
\newacronym[description=通用哈希]{uh}{UH}{\underline{U}niversal \underline{H}ash}
\newacronym[description=推测内容攻击]{lca}{LCA}{\underline{L}earning  \underline{C}ontent \underline{A}ttack}
\newacronym[description=基于特征的加密]{fbe}{FBE}{\underline{F}eature-\underline{B}ased \underline{E}ncryption}
\newacronym[description=相似性保留加密]{spe}{SPE}{\underline{S}imilarity-\underline{P}reserving
\underline{E}ncryption}
\newacronym[description=内容定义数据分块]{cdc}{CDC}{\underline{C}ontent-\underline{D}efined \underline{C}hunking}
\newacronym[description=可信计算基]{tcb}{TCB}{\underline{T}rusted \underline{C}omputing \underline{B}ase}
\newacronym[description=安全监视器调用]{smc}{SMC}{\underline{S}ecure \underline{M}onitor \underline{C}all}
\newacronym[description=数据持有证明]{pdp}{PDP}{\underline{P}roofs of \underline{D}ata \underline{P}ossession}
\newacronym[description=可取回性证明]{por}{PoR}{\underline{P}roofs \underline{o}f \underline{R}etrievability}

\begin{document}
\makecover
% \originalitydeclaration
\signatureofdeclaration{pic/original-signed.pdf}
...
%     \section{学术论文}
%     \bibitem{SGXDedup} \textbf{第一作者}. Accelerating Encrypted Deduplication via SGX[C]. Proc.of USENIX ATC, 2021, 957-971. \textbf{CCF-A, 电子科技大学作为第一单位在该会议发表的首篇论文}
%     \bibitem{TED} 第三作者. Balancing storage efficiency and data confidentiality with tunable encrypted deduplication[C]. Proc. of EuroSys, 2020, 1-15. \textbf{CCF-B, 电子科技大学作为第一单位在该会议发表的首篇论文}
