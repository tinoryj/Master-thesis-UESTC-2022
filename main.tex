...
\newacronym[description=可信执行环境]{tee}{TEE}{Trusted Execution Environment}
\newacronym[description=消息锁加密]{mle}{MLE}{Message-locked Encryption}
\newacronym[description=无记忆伪随机函数]{oprf}{OPRF}{Oblivious pseudorandom function}
\newacronym[description=数据所有权证明]{pow}{PoW}{Proof of Ownership}
...
% First use: \gls{lvm}. Second use: \gls{lvm}.
