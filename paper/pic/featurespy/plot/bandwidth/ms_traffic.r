...
if(T){
    x1 <- read.table("traffic_ms.data",header=TRUE)
    ...
    scale_y_continuous(breaks = trans_breaks("log10", function(x) 10^x)(c(1,15000)), labels = trans_format("log10", math_format(10^.x)),trans = 'log10') +
