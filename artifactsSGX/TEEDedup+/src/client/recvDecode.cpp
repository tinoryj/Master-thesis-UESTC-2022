        ...
        if (respond.messageType == SUCCESS) {
            ...
            for (int i = 0; i < chunkNumber; i++) {
                ...
                if (chunkSize <= PREFIX_LENGTH) {
                    ...
                    cryptoObj_->decryptWithKey((u_char*)respondBuffer + sizeof(NetworkHeadStruct_t) + totalRecvSize, PREFIX_LENGTH, fileRecipeList_[chunkID].chunkKeyFeature, chunkPlaintData);
                    cryptoObj_->decryptWithKey((u_char*)respondBuffer + sizeof(NetworkHeadStruct_t) + totalRecvSize + PREFIX_LENGTH, chunkSize, fileRecipeList_[chunkID].chunkKeyMLE, chunkPlaintData + PREFIX_LENGTH);
                }
