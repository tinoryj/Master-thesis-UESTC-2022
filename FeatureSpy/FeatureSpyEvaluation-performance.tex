...
\begin{table}[!htb]
    ...
    \begin{tabular}{cccc}
        ...
        \midrule
        网络带宽                            & \multicolumn{3}{c}{\hspace{-50pt} 11.8 $\pm$ 0.04}                                                                                      \\
        \makecell[c]{\textit{firstFeature}} & \multirow{3}{*}{11.5 $\pm$ 0.006}                  & \makecell[c]{\hspace{0.5em} 204.4 $\pm$ 10.06} & \multirow{3}{*}{11.5 $\pm$ 0.004} \\
