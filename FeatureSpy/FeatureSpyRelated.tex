...
PoW 可防止恶意客户端在基于源的重复数据删除中损害数据所有权，但无法解决学习内容攻击 (\S\ref{sub:attack})。 \sysnameF 通过主动检测学习内容攻击来补充加密重复数据删除 \cite{ren21}。虽然以前的研究可以通过以不同的方式应用重复数据删除来击败学习内容攻击，但它们会注入网络流量来传输重复的内容。 \sysnameF 执行纯基于源的重复数据删除并实现带宽效率 (Exp\#10)。
