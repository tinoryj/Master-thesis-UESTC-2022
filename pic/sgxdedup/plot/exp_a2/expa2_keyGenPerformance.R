...
if(T){
    ...
    # geom_text(aes(label = round(interval/1024,3)), position = position_dodge(0.9), hjust=0.5, vjust=-0.1,size=4.5,angle=0, color="black",family="Times New Roman") +
    coord_cartesian(ylim=c(308, 6500)) +
    ...
    theme(
      panel.grid.major=element_blank(), panel.grid.minor=element_blank(),
	    ...
	    axis.title.y=element_text(size=11, hjust=0.8,family="Times New Roman"),
    ...
    annotate("text", x = 1, y = 2.11+600+50, label = "0.002", size=4, angle=0, color="black",family="Times New Roman") +
    annotate("text", x = 2, y = 24.07+600+50, label = "0.024", size=4, angle=0, color="black",family="Times New Roman") +
    annotate("text", x = 3, y = 346.02+600+50, label = "0.338", size=4, angle=0, color="black",family="Times New Roman") +
    annotate("text", x = 4, y = 888.03+600+100, label = "0.867", size=4, angle=0, color="black",family="Times New Roman") +
    annotate("text", x = 5, y = 3243.09+600+80, label = "3.166", size=4, angle=0, color="black",family="Times New Roman") +
    annotate("text", x = 6, y = 5438.9+600+300, label = "5.311", size=4, angle=0, color="black",family="Times New Roman")
}
