...
if(T){
    ...
    annotate("text", x = 1, y = 37+20+10, label = "37", size=4.5, angle=0, color="black",family="Times New Roman") +
    annotate("text", x = 2, y = 139+20+10, label = "139", size=4.5, angle=0, color="black",family="Times New Roman") +
    annotate("text", x = 3, y = 305+20+20, label = "305", size=4.5, angle=0, color="black",family="Times New Roman")
}
