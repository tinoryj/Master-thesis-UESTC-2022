...
if(T){
    ...
    x1 <- subset(x1, threading %in% c("yes"))
    cairo_pdf(file="../../expa3_keyScale_performance_number_multiThread.pdf", width=mywidth, height=myheight)
    ...
    coord_cartesian(ylim=c(1.65, 35), xlim=c(1, 35)) +
    # coord_cartesian(ylim=c(200000, 3000000), xlim=c(1, 35)) +
    scale_y_continuous(breaks=seq(0, 30, 10), labels=format(seq(0,30,10), scientific=FALSE)) +
    ...
    xlab("Number of Simulated Clients") +
    theme_bw() +
    theme(
