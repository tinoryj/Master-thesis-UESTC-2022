...
if(T){
    ...
    coord_cartesian(xlim=c(1,117),ylim=c(100,130000)) +
    # scale_y_continuous(breaks = breaks_y(1:1e5),labels=labels_y(breaks_y(1:1e5)) ,trans = 'log10') +
    scale_y_continuous(breaks = trans_breaks("log10", function(x) 10^x)(c(1,60000)), labels = trans_format("log10", math_format(10^.x)),trans = 'log10') +
