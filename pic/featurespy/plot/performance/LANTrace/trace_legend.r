...
if(T){
    ...
    x1$Type <- factor(x1$Type, levels=c("SGXUpload", "DetFirstUpload", "DetMinUpload", "DetAllUpload","SGXDedupDownload","AverageDownload"),labels=c("SGXDedup", "firstFeature", "minFeature", "allFeature","SGXDedup Download","SGXDedup+ Download"))
