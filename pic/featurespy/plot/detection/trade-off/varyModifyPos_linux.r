...
if(T){
    ...
    x1 <- read.table("varyModifyPos_linux.data",header=TRUE)
    cairo_pdf(file="varyModifyPos_linux.pdf", width=mywidth, height=myheight)
    ...
    scale_x_continuous(breaks=c(1,2,3),labels=c("3", "6", "9")) +
