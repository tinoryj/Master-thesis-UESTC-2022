...
if(T){
    ...
    x1 <- read.table("varyBaseFileSize_linux.data",header=TRUE)
    cairo_pdf(file="varyBaseFileSize_linux.pdf", width=mywidth, height=myheight)
    ...
    scale_x_continuous(breaks=c(1,2,3),labels=c("4 KiB", "16 KiB", "64 KiB")) +
