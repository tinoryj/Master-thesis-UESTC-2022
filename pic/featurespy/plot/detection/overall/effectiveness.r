...
if(T){
    ...
    geom_text(aes(label = round(ratio*100,0)), position = position_dodge(0.90), hjust=0.5, vjust=-0.3,size=4.5,angle=0, color="black") +
    ...
    theme(panel.grid.major=element_blank(), panel.grid.minor=element_blank(),
        ...
        axis.title.y=element_text(margin=margin(0, 0, 0, 0), size=16, hjust=0.8),
