...
if(T){
    ...
    x1 <- read.table("prefixDistribution-1000-Linux-first.data",header=TRUE)
    cairo_pdf(file="prefixDistribution-1000-Linux-first.pdf", width=mywidth, height=myheight)
