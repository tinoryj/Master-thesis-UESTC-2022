...
if(T){
    ...
    x1 <- read.table("prefixDistribution-5000-Linux-first.data",header=TRUE)
    cairo_pdf(file="prefixDistribution-5000-Linux-first.pdf", width=mywidth, height=myheight)
    ...
    coord_cartesian(ylim=c(0.00195, 0.042), xlim=c(2.5, 33)) +
