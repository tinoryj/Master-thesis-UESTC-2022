...
if(T){
    ...
    x1 <- read.table("prefixDistribution-10000-CouchDB-all.data",header=TRUE)
    cairo_pdf(file="prefixDistribution-10000-CouchDB-all.pdf", width=mywidth, height=myheight)
