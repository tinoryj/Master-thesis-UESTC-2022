...
if(T){
    ...
    x1 <- read.table("prefixDistribution-5000-CouchDB-first.data",header=TRUE)
    cairo_pdf(file="prefixDistribution-5000-CouchDB-first.pdf", width=mywidth, height=myheight)
