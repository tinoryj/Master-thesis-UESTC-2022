...
if(T){
    ...
    x1 <- read.table("prefixDistribution-5000-CouchDB-min.data",header=TRUE)
    cairo_pdf(file="prefixDistribution-5000-CouchDB-min.pdf", width=mywidth, height=myheight)
