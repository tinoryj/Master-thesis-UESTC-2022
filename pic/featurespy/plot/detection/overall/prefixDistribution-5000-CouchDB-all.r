...
if(T){
    ...
    x1 <- read.table("prefixDistribution-5000-CouchDB-all.data",header=TRUE)
    cairo_pdf(file="prefixDistribution-5000-CouchDB-all.pdf", width=mywidth, height=myheight)
